function Snake2Controller($scope, SolutionsModel) {
    const $ctrl = this
    ...
    function l() {
        if ($ctrl.e.length + 1 >= 5*5*4*2) {
            SolutionsModel.gsc2()
                .then(res => {
                    $ctrl.l11 = res;
                })
            document.getElementById('dtt').setAttribute("style", "text-align: center; margin: auto; margin-top: 20px; margin-bottom: 20px; border: 3px solid #00BEF0; border-radius: 8px; width: 1000px; font-size: 50px; font-family: 'Long Cang', cursive; font-weight: bold; text-shadow: 2px 2px #00BEF0");
            clearInterval($ctrl.loop);
            return;
        }
        $ctrl.l11 = SolutionsModel.l11;
        $ctrl.l22 = SolutionsModel.l22 + ($ctrl.e.length + 1) + SolutionsModel.l44;
        $ctrl.l33 = SolutionsModel.l33;
        document.getElementById('dtt').setAttribute("style", "text-align: center; margin: auto; margin-top: 20px; margin-bottom: 20px; border: 3px solid #00BEF0; border-radius: 8px; width: 400px; font-size: 50px; font-family: 'Long Cang', cursive; font-weight: bold; text-shadow: 2px 2px #00BEF0");
        $scope.$apply();
        clearInterval($ctrl.loop);
    }

    $scope.down = (e) => {
        if (!$ctrl.b && (e.code=="ArrowUp" || e.code=="ArrowRight" || e.code=="ArrowDown" || e.code=="ArrowLeft")) {
            $ctrl.b = true;
    ...
    function r() {
        ...
        $ctrl.b = false;
        document.getElementById('dtt').setAttribute("style", "");
        $ctrl.l11 = "";
        $ctrl.l22 = "";
        $ctrl.l33 = "";
...
angular
    ...
    .controller('Snake2Controller', Snake2Controller)